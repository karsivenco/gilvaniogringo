...
function buildMenu() {
  ...
  const usuariosControle = ["cristiano.santos", "gilvaniogringo", "karina.maia"]; // quem pode acessar controle.html
  ...
  // Adiciona o Painel de Controle apenas para usuários autorizados
  if (usuariosControle.includes(usuario)) {
    menuHTML += `
      <a href="controle.html" class="bg-[#09679c] border border-white px-3 py-2 rounded hover:bg-[#074d6b] transition flex items-center gap-1">
